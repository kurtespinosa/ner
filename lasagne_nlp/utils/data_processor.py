...
def read_conll_sequence_labeling(path, word_alphabet, label_alphabet, word_column=1, label_column=1):
    """
...
def load_dataset_sequence_labeling(train_path, dev_path, test_path, word_column=1, label_column=1,
